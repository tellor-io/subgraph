...
export class DataRequested extends ethereum.Event {
...
export class NewRequestOnDeck extends ethereum.Event {
...
export class LibraryContract extends ethereum.SmartContract {
